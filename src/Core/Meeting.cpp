...
Meeting::Meeting()
    : sponsor_(""), participator_(""), startDate_(Date()), endDate_(Date()), title_("") {}

Meeting::Meeting(std::string sponsor, std::string participator, Date startTime, Date endTime, std::string title)
    : sponsor_(sponsor), participator_(participator), startDate_(startTime), endDate_(endTime), title_(title) {}
